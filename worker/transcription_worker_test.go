...
func (s *stubMessageService) GetMessagesByInstanceID(_, _ string, _ int, _ *time.Time) (*[]model.Message, error) {
	return nil, nil
}
func (s *stubMessageService) GetChatsByInstanceID(_ string) (*[]model.Message, map[string]int64, error) {
	return nil, nil, nil
}
